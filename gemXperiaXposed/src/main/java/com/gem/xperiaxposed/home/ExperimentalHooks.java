...
////////////////////////////////////////////////////////////
  ...
  public void after_loadItemData(AppTrayDrawerLoadHelper thiz, SortMode mode, int i1, int i2, Map<String, List<AppTrayDrawerItemData>> items, boolean b)
  {
  ...
  public Object before_onTransferStart(AppTray thiz, Transferable transferable)
  {
    FolderOpener folderOpener = getField(thiz, "mFolderOpener");
    AppTrayPresenter presenter = getField(thiz, "mAppTrayPresenter");
    if(!folderOpener.hasFolderOpen())
      presenter.enterTransferMode();
    return NULL;
  }
